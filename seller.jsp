...
<body>
			...
			<div class="col-md-12 column">
				...
				<div class="col-md-6 column">
					<ul class="nav navbar-nav ">
						...
						<li class="active"><a href="seller.jsp"><font size=4>Sell</font></a></li>
	...
	<form id="uploadForm" action="post" method="post"
		...
		<div class="col-md-12 column" style="padding: 20px 0px 0px 40px">
			...
			<div class="col-md-1 column">
				<button type="button" class="btn btn-inverse btn-lg"
					onclick="deleteAddedItem()">Delete Added Item</button>
			</div>
		...
		<div style="padding: 60px 0px 0px 40px" class="row clearfix">
												...
												<div class="row clearfix">
													<div class="col-md-12 column">
														...
														<div class="col-md-3 column">
															...
															<div id="itemName1"></div>
															<div id="itemName2"></div>
															<div id="itemName3"></div>
															<div id="itemName4"></div>
															<div id="itemName5"></div>
															<div id="itemName6"></div>
															<div id="itemName7"></div>
															<div id="itemName8"></div>
															<div id="itemName9"></div>
															<div id="itemName10"></div>
															<div id="itemName11"></div>
															<div id="itemName12"></div>
															<div id="itemName13"></div>
															<div id="itemName14"></div>
															<div id="itemName15"></div>
														</div>
													</div>
												</div>
											</div>
			...
			<div class="col-md-12 column" style="padding: 60px 0px 0px 20px">
			...
			<div class="col-md-12 column" style="padding: 60px 0px 0px 40px">
				<div>
					...
					<label class="checkbox-inline"> <input type="radio"
						name="delivery" id="options1" value="1">Included
					</label> <label class="checkbox-inline"> <input type="radio"
						name="delivery" id="options2" value="2"> Only small
						product
					</label> <label class="checkbox-inline"> <input type="radio"
						name="delivery" id="options0" value="0" checked> Not
						included
					</label>
				</div>
				<div style="padding: 60px 0px 0px 0px">
					...
					<div class="col-md-12 column" style="padding: 20px 0px 0px 0px">
						...
						<div class="col-md-3 column">
							<button class="btn-lg btn-info btn-block" type="submit"
...
<script>
			...
			var funAppendImage = function() {
				...
				if (file) {
					...
					reader.onload = function(e) {
						...
						var tempCount = count;
						while (tempCount>=0) {
							option = option + '<option value="'+(count-tempCount+1)+'">item '+(count-tempCount+1)+'</option>';
							tempCount--;
						}
						html = html
								...
								+ '<label>Select itemNo: </label><select name="pictag'+file.name+'" id="pictag'+file.name+'">'+option+'</select>     <!--<input type="text" class="input-default" name="pictag'+file.name+'" id="pictag'+file.name+'">-->'
	...
	function addAnotherItem() {
		...
		$(a)
				.html(
						'<hr style="border:3px double #000" size="2"/> <div class="col-md-12 column" style="padding: 10px 0px 0px 18px">'
	...
	function deleteAddedItem() {
		...
		var itemNum = "#item" + (count + 1);
		var itemName = "#itemName"+(count+1);
		$(itemName).html('');
		$(itemNum).html('');
		$('.selectpicker').selectpicker("refresh");
		count--;
							...
							$(name)
									.html(
											'<h4>item '
													...
													+ ': '
													+ $(this).val()
													+ '</h4> <input type="hidden" value="'+value+'" name="listItem'+key+'">');
						});
	}
</script>
</html>
